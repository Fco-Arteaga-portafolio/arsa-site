...
@Component({
  selector: 'app-tribufi',
  standalone: true,
  imports: [CommonModule],
  templateUrl: './tribufi.html',
  styleUrl: './tribufi.css',
})
export class TribufiComponent implements OnInit, OnDestroy {
  ...
  navigateTo(section: 'inicio' | 'privacidad' | 'eliminar'): void {
    this.router.navigate(['/tribufi', section]);
  }
}